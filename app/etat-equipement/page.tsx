...
export default function EtatEquipement() {
   const metro_lines = [
        ...
        { code: "14", imageSrc: "/picto/metros/metro_14.png", hasEquipementsForAccessibility: true },
      ]

      const rer_lines = [
        { code: "A", imageSrc: "/picto/rers/rer_a.png", hasEquipementsForAccessibility: true },
        { code: "B", imageSrc: "/picto/rers/rer_b.png" },
      ]
  ...
  return (
    <div className="bg-gray-300 h-screen p-4 flex flex-col gap-4">
        <h1 className="text-2xl font-bold">État des ascenseurs sur les lignes RATP</h1>
        <p>
        Retrouvez en direct l’état des ascenseurs par ligne. Sélectionnez préalablement une ligne afin d’accéder au détail par station. 
        </p>
        <LineFamilyCard family="rer" lines={rer_lines} />
