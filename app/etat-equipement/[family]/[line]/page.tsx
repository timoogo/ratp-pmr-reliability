...
function getStationStatus(
  equipments: { status: EquipmentStatus; type: EquipmentType }[]
): "ok" | "warning" | "current" {
  const elevators = equipments.filter(
    (e) => e.type === EquipmentType.ASCENSEUR
  );
  ...
  return (
    <div className="p-4 flex flex-col gap-4 bg-gray-200 min-h-screen">
      <h1 className="text-2xl font-bold">
        État des ascenseurs du Métro {line}
      </h1>
